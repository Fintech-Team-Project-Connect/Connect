...
SELECT * FROM manage JOIN study ON manage.study_sId = study.sId WHERE manage.user_uId = '4767';
...
SELECT * FROM cafe JOIN (study, user) ON cafe.cAccount = study.cafe_cAccount AND user.uId='4767' WHERE study.cafe_cAccount in ('2222-2222');